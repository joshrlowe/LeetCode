...
def test_level_order():
    ...
    expected7 = [[3], [9], [15], [7]]
    result7 = solution.levelOrder(tree7)
    assert (
        result7 == expected7
    ...
    expected8 = [[3], [9], [15], [7]]
    result8 = solution.levelOrder(tree8)
    assert (
        result8 == expected8
    ...
    expected9 = [[1], [2, 3], [4, 5, 6], [7, 8]]
    result9 = solution.levelOrder(tree9)
    assert (
        result9 == expected9
    ...
    result10 = solution.levelOrder(tree10)
    assert (
        result10 == expected10
