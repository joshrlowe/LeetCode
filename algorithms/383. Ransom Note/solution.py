...
def test_can_construct():
    ...
    magazine1 = "b"
    assert (
        solution.canConstruct(ransomNote1, magazine1) == False
    ...
    magazine2 = "aab"
    assert (
        solution.canConstruct(ransomNote2, magazine2) == True
    ), "Test Case 2 - Exact match Failed"
    print("Passed")
    ...
    magazine3 = "aabb"
    assert (
        solution.canConstruct(ransomNote3, magazine3) == True
    ), "Test Case 3 - More letters in magazine than needed Failed"
    print("Passed")
    ...
    magazine4 = "aab"
    assert (
        solution.canConstruct(ransomNote4, magazine4) == False
    ), "Test Case 4 - Not enough letters in magazine Failed"
    print("Passed")
    ...
    magazine5 = "aabbcc"
    assert (
        solution.canConstruct(ransomNote5, magazine5) == True
    ), "Test Case 5 - Magazine contains all letters of ransom note Failed"
    print("Passed")
    ...
    magazine6 = "abc"
    assert (
        solution.canConstruct(ransomNote6, magazine6) == True
    ), "Test Case 6 - Empty ransom note Failed"
    print("Passed")
    ...
    magazine7 = ""
    assert (
        solution.canConstruct(ransomNote7, magazine7) == False
    ), "Test Case 7 - Empty magazine Failed"
    print("Passed")
    ...
    magazine8 = "aabbaa"
    assert (
        solution.canConstruct(ransomNote8, magazine8) == True
    ), "Test Case 8 - Ransom note contains repeating letters Failed"
    print("Passed")
    ...
    magazine9 = "abc"
    assert (
        solution.canConstruct(ransomNote9, magazine9) == True
    ), "Test Case 9 - Magazine and ransom note are the same Failed"
    print("Passed")
    ...
    magazine10 = "aaab"
    assert (
        solution.canConstruct(ransomNote10, magazine10) == False
    ), "Test Case 10 - Magazine has multiple of the same letter, but ransom note has more Failed"
    print("Passed")
