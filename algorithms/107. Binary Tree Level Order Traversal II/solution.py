...
def test_level_order_bottom():
    ...
    expected1 = [[15, 7], [9, 20], [3]]
    result1 = solution.levelOrderBottom(tree1)
    assert (
        result1 == expected1
    ...
    tree2 = build_tree([1])
    expected2 = [[1]]
    result2 = solution.levelOrderBottom(tree2)
    assert (
        result2 == expected2
    ...
    tree3 = build_tree([])
    expected3 = []
    result3 = solution.levelOrderBottom(tree3)
    assert (
        result3 == expected3
    ...
    expected4 = [[4, 5, 6, 7], [2, 3], [1]]
    result4 = solution.levelOrderBottom(tree4)
    assert (
        result4 == expected4
    ...
    expected5 = [[4], [3], [2], [1]]
    result5 = solution.levelOrderBottom(tree5)
    assert (
        result5 == expected5
    ...
    expected6 = [[4], [3], [2], [1]]
    result6 = solution.levelOrderBottom(tree6)
    assert (
        result6 == expected6
    ...
    expected7 = [[7], [15], [9], [3]]
    result7 = solution.levelOrderBottom(tree7)
    assert (
        result7 == expected7
    ...
    expected8 = [[7], [15], [9], [3]]
    result8 = solution.levelOrderBottom(tree8)
    assert (
        result8 == expected8
    ...
    expected9 = [[7, 8], [4, 5, 6], [2, 3], [1]]
    result9 = solution.levelOrderBottom(tree9)
    assert (
        result9 == expected9
    ...
    result10 = solution.levelOrderBottom(tree10)
    assert (
        result10 == expected10
